...
def lt_num_2d(double[:, :] a, double b):  # 二维矩阵比较小于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    s = np.zeros((dim_1, dim_2))
    cdef double[:, :] s_view = s
...
def lt_num_3d(double[:, :, :] a, double b):  # 三维矩阵比较小于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    cdef Py_ssize_t dim_3 = a.shape[2]
    s = np.zeros((dim_1, dim_2. dim_3))
...
def le_num_2d(double[:, :] a, double b):  # 二维矩阵比较小于等于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    s = np.zeros((dim_1, dim_2))
    cdef double[:, :] s_view = s
...
def le_num_3d(double[:, :, :] a, b):  # 三维矩阵比较小于等于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    cdef Py_ssize_t dim_3 = a.shape[2]
    s = np.zeros((dim_1, dim_2. dim_3))
...
def gt_num_2d(double[:, :] a, b):  # 二维矩阵比较大于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    s = np.zeros((dim_1, dim_2))
    cdef double[:, :] s_view = s
...
def gt_num_3d(double[:, :, :] a, b):  # 三维矩阵比较大于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    cdef Py_ssize_t dim_3 = a.shape[2]
    s = np.zeros((dim_1, dim_2. dim_3))
...
def ge_num_2d(double[:, :] a, b):  # 二维矩阵比较大于等于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    s = np.zeros((dim_1, dim_2))
    cdef double[:, :] s_view = s
...
def ge_num_3d(double[:, :, :] a, b):  # 三维矩阵比较大于等于
    cdef Py_ssize_t dim_1 = a.shape[0]
    cdef Py_ssize_t dim_2 = a.shape[1]
    cdef Py_ssize_t dim_3 = a.shape[2]
    s = np.zeros((dim_1, dim_2. dim_3))
